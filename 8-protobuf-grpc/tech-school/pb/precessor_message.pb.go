...
// 	protoc        v3.17.2
// source: precessor_message.proto
...
func (x *CPU) Reset() {
	*x = CPU{}
	if protoimpl.UnsafeEnabled {
		mi := &file_precessor_message_proto_msgTypes[0]
...
func (*CPU) Descriptor() ([]byte, []int) {
	return file_precessor_message_proto_rawDescGZIP(), []int{0}
}
...
func (x *GPU) Reset() {
	*x = GPU{}
	if protoimpl.UnsafeEnabled {
		mi := &file_precessor_message_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GPU) Descriptor() ([]byte, []int) {
	return file_precessor_message_proto_rawDescGZIP(), []int{1}
}
...
var File_precessor_message_proto protoreflect.FileDescriptor

var file_precessor_message_proto_rawDesc = []byte{
	0x0a, 0x17, 0x70, 0x72, 0x65, 0x63, 0x65, 0x73, 0x73, 0x6f, 0x72, 0x5f, 0x6d, 0x65, 0x73, 0x73,
...
var (
	file_precessor_message_proto_rawDescOnce sync.Once
	file_precessor_message_proto_rawDescData = file_precessor_message_proto_rawDesc
)

func file_precessor_message_proto_rawDescGZIP() []byte {
	file_precessor_message_proto_rawDescOnce.Do(func() {
		file_precessor_message_proto_rawDescData = protoimpl.X.CompressGZIP(file_precessor_message_proto_rawDescData)
	})
	return file_precessor_message_proto_rawDescData
}

var file_precessor_message_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_precessor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: techschool.pcbook.CPU
	(*GPU)(nil),    // 1: techschool.pcbook.GPU
	(*Memory)(nil), // 2: techschool.pcbook.Memory
}
var file_precessor_message_proto_depIdxs = []int32{
...
func init() { file_precessor_message_proto_init() }
func file_precessor_message_proto_init() {
	if File_precessor_message_proto != nil {
		return
	}
	file_memory_message_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_precessor_message_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CPU); i {
			case 0:
				return &v.state
			case 1:
		...
		file_precessor_message_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GPU); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_precessor_message_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_precessor_message_proto_goTypes,
		DependencyIndexes: file_precessor_message_proto_depIdxs,
		MessageInfos:      file_precessor_message_proto_msgTypes,
	}.Build()
	File_precessor_message_proto = out.File
	file_precessor_message_proto_rawDesc = nil
	file_precessor_message_proto_goTypes = nil
	file_precessor_message_proto_depIdxs = nil
}
