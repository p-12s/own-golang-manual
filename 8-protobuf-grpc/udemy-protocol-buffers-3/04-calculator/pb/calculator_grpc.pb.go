...
type CalculatorServiceClient interface {
	...
	// Unary, with deadline
	DeadlineExample(ctx context.Context, in *DeadlineRequest, opts ...grpc.CallOption) (*DeadlineResponse, error)
}
...
func (c *calculatorServiceClient) DeadlineExample(ctx context.Context, in *DeadlineRequest, opts ...grpc.CallOption) (*DeadlineResponse, error) {
	out := new(DeadlineResponse)
	err := c.cc.Invoke(ctx, "/calculator.CalculatorService/DeadlineExample", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculatorServiceServer interface {
	...
	// Unary, with deadline
	DeadlineExample(context.Context, *DeadlineRequest) (*DeadlineResponse, error)
}
...
func (UnimplementedCalculatorServiceServer) Sum(context.Context, *SumRequest) (*ResultResponse, error) {
...
func (UnimplementedCalculatorServiceServer) DeadlineExample(context.Context, *DeadlineRequest) (*DeadlineResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeadlineExample not implemented")
}
...
func _CalculatorService_DeadlineExample_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeadlineRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalculatorServiceServer).DeadlineExample(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculator.CalculatorService/DeadlineExample",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServiceServer).DeadlineExample(ctx, req.(*DeadlineRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CalculatorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeadlineExample",
			Handler:    _CalculatorService_DeadlineExample_Handler,
		},
	},
